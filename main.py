...
for x in range(parametre.generationTotal):
	...
	print("\033[34mBest score of this generation: \033[0m ", parametre.scoreList[0][0])

print("***************")
print("\033[32mTHE BEST SCORE THROUGH THE EVOLUTION \033[0m")
print("Best score:", parametre.meilleurScore)
print("The route:", parametre.meilleurScoreRoute)
print("***************")
print("***************")
print("\033[33mBEST PRICE / TIME RATION \033[0m")
